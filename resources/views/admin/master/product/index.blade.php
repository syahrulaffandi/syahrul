           ...
           <div class="table">
               <table class="table table-striped table-hover table-responsive" id="table">
                    ...
                    <tbody>
                        ...
                        <td>{{ $item->stock}}</td>
                        <td>
                        <img src="{{URL::asset('uploads/'.$item->latestImage()->first()->image)}}" alt="" width="60px" height="50px">
                        </td>
                            <td>
                            <a href="{{ route('product.show',$item->id)}}" class="btn btn-sm btn-primary"><span class="fa fa-external-link"></span> detail</a>
                            <a href="{{ route('product.edit',$item->id)}} " class="btn btn-sm btn-success"><span class="fa fa-edit"></span> update</a>
